# =============================================================================
# Packer Template: Windows Server 2025 for Hyper-V
# =============================================================================
#
# This template creates a Windows Server 2025 base image with:
...
variable "ws2025_iso_path" {
  type        = string
  description = "Path to Windows Server 2025 ISO"
}

variable "ws2025_iso_checksum" {
  type        = string
...
variable "ws2025_product_key" {
  type        = string
  description = "Windows Server 2025 product key (optional)"
  default     = ""
}
...
source "hyperv-iso" "ws2025" {
  ...
  disk_block_size      = 1  # 1MB block size for better performance

  # ISO Configuration
  iso_url              = var.ws2025_iso_path
  iso_checksum         = var.ws2025_iso_checksum
  ...
  # Skip export for template (we'll use the VHDX directly)
  skip_export          = false
